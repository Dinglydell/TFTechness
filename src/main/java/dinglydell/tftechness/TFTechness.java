...
public class TFTechness {
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		ConfigCategory invar = config.getCategory("invar");
		invar.get
	...
	private void registerHeat() {
		...
		HeatRaw invarRaw = new HeatRaw(0.52, 1700);
		HeatRaw mithrilRaw = new HeatRaw(0.9, 660);
		HeatRaw electrumRaw = new HeatRaw(0.181, 650);
		HeatRaw enderiumRaw = new HeatRaw(0.5, 1700);
		HeatRaw signalumRaw = new HeatRaw(0.45, 1300);
		// TODO: fix this for the metals
	...
	private Material[] getMaterials() {
		return new Material[] {
				// TODO: HeatRaw for vanilla tfc metals
		new Material(TFCItems.goldUnshaped, TFCItems.goldSheet2x, TFItems.gearGold, 2, null) {
			public Item getUnshaped() {
				return TFCItems.goldUnshaped;
			}

			public Item getSheet2x() {
				return null;
			}
		},
				new Material(TFCItems.wroughtIronUnshaped, TFCItems.wroughtIronSheet2x, TFItems.gearIron, 3, null),
				new Material(TFCItems.copperUnshaped, TFCItems.copperSheet2x, TFItems.gearCopper, 1, null),
				new Material(TFCItems.tinUnshaped, TFCItems.tinSheet2x, TFItems.gearTin, 0, null),
				new Material(TFCItems.silverUnshaped, TFCItems.silverSheet2x, TFItems.gearSilver, 2, null),
				new Material(TFCItems.leadUnshaped, TFCItems.leadSheet2x, TFItems.gearLead, 2, null),
				new Material(TFCItems.nickelUnshaped, TFCItems.nickelSheet2x, TFItems.gearNickel, 4, null),
				new Material(TFCItems.platinumUnshaped, TFCItems.platinumSheet2x, TFItems.gearPlatinum, 3, null),
				new Material(TFCItems.bronzeUnshaped, TFCItems.bronzeSheet2x, TFItems.gearBronze, 2, null),
				new Material(TFTItems.invarUnshaped, TFTItems.invarIngot, TFTItems.invarIngot2x, TFTItems.invarSheet,
						TFTItems.invarSheet2x, TFItems.gearInvar, 4, new HeatRaw(0.52, 1700)),
				new Material(TFTItems.mithrilUnshaped, TFTItems.mithrilIngot, TFTItems.mithrilIngot2x,
						TFTItems.mithrilSheet, TFTItems.mithrilSheet2x, TFItems.gearMithril, 4, new HeatRaw(0.9, 660)),
				new Material(TFTItems.electrumUnshaped, TFTItems.electrumIngot, TFTItems.electrumIngot2x,
						TFTItems.electrumSheet, TFTItems.electrumSheet2x, TFItems.gearElectrum, 5, new HeatRaw(0.181,
								650)),
				new Material(TFTItems.enderiumUnshaped, TFTItems.enderiumIngot, TFTItems.enderiumIngot2x,
						TFTItems.enderiumSheet, TFTItems.enderiumSheet2x, TFItems.gearEnderium, 6, new HeatRaw(0.5,
								1700)),
				new Material(TFTItems.signalumUnshaped, TFTItems.signalumIngot, TFTItems.signalumIngot2x,
						TFTItems.signalumSheet, TFTItems.signalumSheet2x, TFItems.gearSignalum, 5, new HeatRaw(0.45,
								1300))
		};
	}
