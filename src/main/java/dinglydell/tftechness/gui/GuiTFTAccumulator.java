...
public class GuiTFTAccumulator extends GuiAugmentableBase {
	...
	public static final ResourceLocation TEXTURE = new ResourceLocation(TFTechness.MODID
			+ ":textures/gui/machine/Accumulator.png");
	...
	public void initGui() {
		...
		slotOutput = addElement(new ElementSlotOverlay(this, 152, 9).setSlotInfo(Colours.orange.gui(), 3, 2));
		// salt water tank orange highlight
		slotOutput2 = addElement(new ElementSlotOverlay(this, 8, 9).setSlotInfo(Colours.orange.gui(), 3, 2));
		// fresh water tank red highlight
		slotOutputRed = addElement(new ElementSlotOverlay(this, 152, 9).setSlotInfo(Colours.red.gui(), 3, 2));
		// salt water tank yellow highlight
		slotOutput2Yellow = addElement(new ElementSlotOverlay(this, 8, 9).setSlotInfo(Colours.yellow.gui(), 3, 2));
		
		// fresh water tank
		addElement(new ElementFluidTank(this, 152, 9, myTile.getTank()).setAlwaysShow(true));
		// salt water tank
		addElement(new ElementFluidTank(this, 8, 9, ((TileTFTAccumulator) myTile).getTank2()).setAlwaysShow(true));
	}
