...
public class ElementFluidTankMixed extends ElementBase {
	...
	public static final String mixedTankUnlocalised = "info."
			+ TFTechness.MODID + ".tank.mixed.name";
	...
	public void drawBackground(int mouseX, int mouseY, float gameTicks) {
		...
		for (FluidStackFloat fs : tank.getFluids()) {
			...
			gui.drawFluid(posX, y -= amt, fs.getFluidStack(), sizeX, amt);
	...
	private int getScaledAmount(FluidStackFloat fs) {
